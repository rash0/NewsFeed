      ...
      <div className="Postcard card mb-3">
        ...
        <ul className="list-group list-group-flush">
          <li className="list-group-item">
            ...
            <img className="pl-3" src={require('./face.png')} alt='So.icon' onClick={() => alert('Sorry, social media service is not attachad!!')}/>
            <img className="pl-3" src={require('./twit.png')} alt='So.icon' onClick={() => alert('Sorry, social media service is not attachad!!')}/>
